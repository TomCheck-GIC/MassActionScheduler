 ...
 * embeds masCfeConfigWizard inline (with no recordId, its supported "create" mode)
 ...
 */
export default class MasCfeConfigList extends NavigationMixin(LightningElement) {
    showWizard = false;
    ...
    handleWizardSaved(event) {
        ...
        this[NavigationMixin.Navigate]({
            ...
            attributes: {
                objectApiName: 'MAS_CFE_Configuration__c',
