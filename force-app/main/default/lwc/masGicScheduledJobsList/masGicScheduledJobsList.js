...
import getScheduledJobs from '@salesforce/apex/MAS_GIC_ConfigController.getScheduledJobs';
 ...
 */
export default class MasGicScheduledJobsList extends LightningElement {
    columns = COLUMNS;
    jobs = [];
    isLoading = true;
    error;
    ...
    wiredJobs(result) {
        ...
        if (data) {
            this.jobs = data.map((job) => ({
                ...job,
                configUrl: `/lightning/r/MAS_GIC_Configuration__c/${job.configId}/view`
            }));
