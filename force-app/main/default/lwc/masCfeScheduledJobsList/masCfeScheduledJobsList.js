...
import getScheduledJobs from '@salesforce/apex/MAS_CFE_ConfigController.getScheduledJobs';
 ...
 */
export default class MasCfeScheduledJobsList extends LightningElement {
    columns = COLUMNS;
    jobs = [];
    isLoading = true;
    error;
    ...
    wiredJobs(result) {
        ...
        if (data) {
            this.jobs = data.map((job) => ({
                ...job,
                configUrl: `/lightning/r/MAS_CFE_Configuration__c/${job.configId}/view`
            }));
