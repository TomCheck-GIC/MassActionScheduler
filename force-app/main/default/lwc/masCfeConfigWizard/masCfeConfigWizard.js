...
import getConfig from '@salesforce/apex/MAS_CFE_ConfigController.getConfig';
import getMappings from '@salesforce/apex/MAS_CFE_ConfigController.getMappings';
import getActiveFlows from '@salesforce/apex/MAS_CFE_ConfigController.getActiveFlows';
import getInvocableApexClasses from '@salesforce/apex/MAS_CFE_ConfigController.getInvocableApexClasses';
import getActionInputs from '@salesforce/apex/MAS_CFE_ConfigController.getActionInputs';
import previewSource from '@salesforce/apex/MAS_CFE_ConfigController.previewSource';
import runNow from '@salesforce/apex/MAS_CFE_ConfigController.runNow';
import saveConfig from '@salesforce/apex/MAS_CFE_ConfigController.saveConfig';
import saveMappings from '@salesforce/apex/MAS_CFE_ConfigController.saveMappings';
import saveSchedule from '@salesforce/apex/MAS_CFE_ConfigController.saveSchedule';
import unschedule from '@salesforce/apex/MAS_CFE_ConfigController.unschedule';
...
export default class MasCfeConfigWizard extends LightningElement {
    /** MAS_CFE_Configuration__c record Id (populated on a Record Page). */
    @api recordId;

    // ----- Reactive state -----
    @track config = {}; // mutable copy of the MAS_CFE_Configuration__c sObject
