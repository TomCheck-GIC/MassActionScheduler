 ...
 * embeds masGicConfigWizard inline (with no recordId, its supported "create" mode)
 ...
 */
export default class MasGicConfigList extends NavigationMixin(LightningElement) {
    showWizard = false;
    ...
    handleWizardSaved(event) {
        ...
        this[NavigationMixin.Navigate]({
            ...
            attributes: {
                objectApiName: 'MAS_GIC_Configuration__c',
